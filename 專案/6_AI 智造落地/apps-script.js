 ...
 *   AI智造落地報名表單 ……… 報名資料:doPost 自動建立、寫入 + 寄確認信
 *
 * ════════ 部署步驟 ════════
...
function doGet(e) {
  ...
  return ContentService.createTextOutput('AI 智造落地報名 API 運作中 ✓');
}
...
// 貼完程式先手動跑一次:建好「AI智造落地報名表單」分頁並補齊欄位、順便完成授權
